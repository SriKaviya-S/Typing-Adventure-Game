...
function Level9Game() {
  ...
  const calculateProgress = () => {
    return `${wordsCompleted}/20 words`;
  };
  ...
  useEffect(() => {
    if (gameOver && wordsCompleted === level9Words.length && !levelUpdated) {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      currentIndex++;
    }, 2000); // Increased from 1200 to 2000 for more distance between obstacles
  ...
  const levelPassed = wordsCompleted === 20;
      ...
      <div className="game-container" style={{
        ...
        {gameOver && (
          <div style={{
            ...
            <p>Words Completed: {wordsCompleted}/20</p>
            
            {levelPassed ? (
              <p style={{ color: "#FF9800" }}>
                Congratulations! All words completed! {levelUpdated ? "Progress saved!" : "Saving progress..."} 
                You can proceed to Level 10!
              </p>
            ) : (
              <p style={{ color: "#ff4444" }}>
                Try again! You need to complete all 20 words to pass the level.
              </p>
            )}
