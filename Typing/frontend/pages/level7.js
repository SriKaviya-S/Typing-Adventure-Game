...
function Level7Game() {
  ...
  const [timeLeft, setTimeLeft] = useState(45); // Increased time for more words
  ...
  const [obstacleSpeed, setObstacleSpeed] = useState(1.3); // Increased initial speed for Level 7
  ...
  const calculateProgress = () => {
    return `${wordsCompleted}/25 words`;
  };
  ...
  useEffect(() => {
    if (gameOver && wordsCompleted === level7Words.length && !levelUpdated) {
  ...
  useEffect(() => {
    if (timeLeft > 0 && !gameOver && !allWordsCompleted) {
      const timer = setInterval(() => {
        ...
        setObstacleSpeed(prev => Math.min(prev + 0.01, 2.0)); // Faster speed increase for Level 7
      }, 1000);
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      currentIndex++;
    }, 1600); // Faster obstacle spawn rate for Level 7
  ...
  const handleWordMatch = () => {
    setJumping(true);
    const basePoints = currentWord.length === 5 ? 20 : 20; // Increased points for Level 7
  ...
  const levelPassed = wordsCompleted === 25;
    ...
    <div className="App" style={{ backgroundColor: "black", height: "100vh" }}>
      <div className="game-container" style={{
        ...
        {gameOver && (
          <div style={{
            ...
            <p>Words Completed: {wordsCompleted}/25</p>
            ...
            {levelPassed ? (
              ...
              <p style={{ color: "#ff4444" }}>
                Try again! You need to complete all 25 words to pass the level.
              </p>
            )}
        ...
        <div className="word-display" style={{
          ...
          transform: "translateX(-50%)",
          fontSize: "24px",
          color: "white", // Changed to light green
          textAlign: "center",
          zIndex: "1"
        }}>
          <span style={{
            ...
            padding: "5px 15px",
            background: "linear-gradient(to right, #4CAF50, #45a049)", // Changed to green
            borderRadius: "10px",
            boxShadow: "0 0 10px rgba(76, 175, 80, 0.8)", // Changed to green
            textShadow: "2px 2px 4px rgba(0,0,0,0.5)"
          }}>
      ...
      <input
        ...
        style={{
          ...
          fontSize: "18px",
          borderRadius: "5px",
          border: "2px solid #4CAF50", // Changed to green
      ...
      <style>
        {`
          ...
          .typing-input:focus {
            outline: none;
            box-shadow: 0 0 10px #4CAF50; // Changed to green
